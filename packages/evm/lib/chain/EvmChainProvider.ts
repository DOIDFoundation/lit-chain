import { Chain, Fee } from '@lit-chain/client';
import { BlockNotFoundError, NodeError, TxNotFoundError, UnsupportedMethodError } from '@lit-chain/errors';
import { Logger } from '@lit-chain/logger';
import { AddressType, Asset, AssetTypes, BigNumber, Block, FeeDetails, Network, TokenDetails, Transaction } from '@lit-chain/types';
import { ensure0x } from '@lit-chain/utils';
 ...
 * import { EvmNetworks, EvmChainProvider } from '@lit-chain/evm';
 *
