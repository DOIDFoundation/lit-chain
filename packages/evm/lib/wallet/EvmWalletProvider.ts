import { Chain } from '@lit-chain/client';
import { Address, NamingProvider, Network, WalletOptions } from '@lit-chain/types';
import { compare, remove0x } from '@lit-chain/utils';
